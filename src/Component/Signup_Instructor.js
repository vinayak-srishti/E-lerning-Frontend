                            ...
                            <div class="card-body p-6">
                                <div class="mb-4">
                                    ...
                                    <span>
                                        ...
                                        <a href="/logininstructor" class="ms-1">Login</a>
                                    </span>
                                </div>
                                <form>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="Course Name"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="Qualification"/>
                                            <label for="floatingInput">Qualification</label>
                                        </div>
                                        </div>
                                        <div class="col-md-6 mb-4 pb-2">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="Experiance"/>
                                            <label for="floatingInput">Experiance</label>
                                        </div>
                                        </div>
                                    </div>
                                    <div class="row">
